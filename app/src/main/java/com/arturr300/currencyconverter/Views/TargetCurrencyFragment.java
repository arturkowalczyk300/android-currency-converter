...
public class TargetCurrencyFragment extends SourceTargetCurrencyFragment {
    public static final String FRAGMENT_REQUEST_KEY = "com.arturr300.currencyconverter.FRAGMENT_REQUEST_KEY_TARGET";
    public static final String BUNDLE_VIEW_CREATED = "com.arturr300.currencyconverter.BUNDLE_VIEW_CREATED_TARGET";
